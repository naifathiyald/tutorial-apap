...
public class DestinasiRestController {
    ...
    private DestinasiModel createDestinasi(
            @Valid @RequestBody DestinasiModel destinasi,
    ...
    private DestinasiModel retrieveDestinasi(
    ...
    private ResponseEntity deleteDestinasi(
            @PathVariable("noDestinasi") Long noDestinasi
    ){
        try {
            ...
            throw new ResponseStatusException(
                    HttpStatus.BAD_REQUEST, "Destinasi is still open or has Tour Guide!"
            );
        }
    ...
    private DestinasiModel updateDestinasi(
            @PathVariable("noDestinasi") Long noDestinasi,
            @RequestBody DestinasiModel destinasi
    ){
        try {
