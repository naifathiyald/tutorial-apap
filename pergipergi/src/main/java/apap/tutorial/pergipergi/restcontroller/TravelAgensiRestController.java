...
public class TravelAgensiRestController {
    ...
    private TravelAgensiModel createTravelAgensi(
            @Valid @RequestBody TravelAgensiModel agensi,
    ...
    private TravelAgensiModel retrieveAgensi(
            @PathVariable("noAgensi") Long noAgensi
    ){
        try {
    ...
    private ResponseEntity deleteAgensi(
            @PathVariable("noAgensi") Long noAgensi
    ){
        try {
    ...
    private TravelAgensiModel updateAgensi(
            @PathVariable("noAgensi") Long noAgensi,
            @RequestBody TravelAgensiModel agensi
    ){
        try {
